...
namespace DepartmentManager.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,StudentName,StudentReg,DepartmentId")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,StudentName,StudentReg,DepartmentId")] Student student)
        {
            if (ModelState.IsValid)
            {
